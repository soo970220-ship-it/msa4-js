...
// 들킨 div에는 마우스가 진입해도 두근두근이 뜨지 않습니다.
//이를 위해서는 위의 두근두근을 지우고 함수를 이용해야한다
// 1.함수 선언식 (선언식은 백에서 많이쓴다)
// 2.함수 표현식 (프론트는 표현식을 많이쓴다)
//선언식은 아무데나 적어도 된다 (호이스팅이 되기때문)
//표현식은 호이스팅 x 보통 함수모음을 최상단에 적어놓음 function button()
